...
This version of crypto11 requires Go 1.26 or newer. Install the library by running:

> **Note on Go version policy**
>
> The `go 1.26.0` directive in `go.mod` is the minimum supported version for
> consumers. Maintainers may use a newer compatible toolchain.
